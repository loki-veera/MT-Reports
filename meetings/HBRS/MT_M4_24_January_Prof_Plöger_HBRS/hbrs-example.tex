...
\begin{frame}{Content}
    \begin{itemize}
        ...
        %\item[4.] Probabilities distribution (ID-OOD)
...
\begin{frame}{Recap-OOD Vs Anomaly}
    \begin{figure}
        \centering
        \includegraphics[scale=0.25]{theme/images/oodvanom.png}
        \caption{.}
    \end{figure}
\end{frame}
\begin{frame}{Recap-RandLA-Net}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth, height=0.4\textheight]{theme/images/LFA_module.png}

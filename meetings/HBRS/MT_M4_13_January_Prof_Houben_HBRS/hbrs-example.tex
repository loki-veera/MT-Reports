...
\begin{frame}{Content}
    \begin{itemize}
        ...
        \item[4.] Max prediction probabilities distribution (ID-OOD)
        \item[5.] Entropies distribution (ID-OOD)
        \item[6.] Next Steps 
    \end{itemize}
\end{frame}
...
\begin{frame}{Recap}
    \begin{itemize}
        \item[$\bullet$] RandLA-Net as model because of architectural advantage
...
\begin{frame}{RandLA-Net Semantic3D ensemble performance}
    \begin{table}[h!]
        ...
        \textbf{\#Ensembles} & \textbf{MeanIOU} & \textbf{Accuracy} & \textbf{IOU-Manmadeterrain} & \textbf{IOU-Naturalterrain} & \textbf{IOU-Highvegetation} & \textbf{IOU-Lowvegetation} & \textbf{IOU-Buildings} & \textbf{IOU-Hardscapes} & \textbf{IOU-Scanningartifacts} & \textbf{IOU-Cars} \\ \hline
        1& 69.53& 90.06& 95.18& 83.34& 87.46& 31.83& 83.76& 20.47& 62.98& 91.27\\
        5& 70.20& 90.08& 95.26& 83.86& \textbf{88.95}& 32.02& 83.61& 20.66& \textbf{64.36}& 92.94\\
        10& 70.52& 90.47& 95.08& 83.3& 86.52& 27.81& \textbf{85.77}& \textbf{32.43}& 62.22& 91.06\\
        15& 70.40& \textbf{90.61}& 95.26& 84.13& 88.16 & 31.41& 85.43& 26.24 & 59.62& \textbf{92.98}\\
        20& \textbf{70.52}& 90.50& \textbf{95.38}& \textbf{84.27}& 86.94& \textbf{33.7}& 85.16& 26.89& 61.78& 90.05\\
        \end{tabular}%
        }
...
\begin{frame}{RandLA-Net Semantic3D ensemble performance}
    \begin{figure}[h!]
        \centering
        \includegraphics[scale=0.2]{theme/images/distribution.png}
...
\begin{frame}{RandLA-Net Semantic3D ensemble performance}
    \begin{figure}
        \includegraphics[width=0.49\textwidth]{theme/images/ensemble_max_prob_sem3d_plot.png}
        \hfill
        \includegraphics[width=0.49\textwidth]{theme/images/ensemble_entropy_sem3d_plot.png}
    \end{figure}
\end{frame}
\begin{frame}{Out-of-distribution (OOD) dataset - S3DIS}
    ...
    \begin{table}
        ...
        \begin{tabular}{cc}
            \hline
            \textbf{Semantic3D} & \textbf{S3DIS} \\ \hline
        ...
        \caption{Classes in both the datasets, ID dataset is Semantic3D and OOD dataset is S3DIS}

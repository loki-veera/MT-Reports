...
\begin{document}
    ...
    This kind of dataset captures the static information of the real world whereas sequential datasets also capture the dynamic movements of the surrounding objects.

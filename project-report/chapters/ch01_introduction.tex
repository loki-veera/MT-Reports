...
The Tesla autonomous driving platform encounters one such problem of misdetection of an unknown object.
\begin{figure}[h!]
...
\begin{enumerate}
    ...
    \item Benchmarking of 3D LiDAR datasets for OOD detection. Proposed two benchmark datasets Sematic3D vs S3DIS and Semantic3D vs Semantic3D without colour, with Semantic3D being In-Distribution (ID) dataset and S3DIS and Semantic3D without colour being Out-Of-Distribution (OOD) datasets.

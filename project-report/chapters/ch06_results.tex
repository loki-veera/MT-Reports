...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \end{figure*}
    From Table~\ref{tab:ensemble_eval}, we infer that classes Low vegetation and Hardscapes have lower per-class IoU scores, this is because of lack of training data.

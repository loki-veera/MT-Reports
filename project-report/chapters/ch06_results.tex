...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{figure}[h!]
        \begin{subfigure}{0.49\textwidth}
            ...
            \includegraphics[scale=0.36]{images/AUROC/MSP_10.pdf}
            \caption{}
            \label{fig:roc_msp_10_ood_1}
        \end{subfigure}
        \begin{subfigure}{0.495\textwidth}
            %\centering
            \includegraphics[scale=0.36]{images/AUROC/Entropy_10.pdf}
            \caption{}
            \label{fig:roc_ent_10_ood_1}
        \end{subfigure}
        ROC curves of Semantic3D-vs-S3DIS for 10 Ensembles, 10 forward passes for Flipout and Dropout. (a) representing the ROC curve from MSP and (b) representing the ROC curve from the entropy score.
    \end{figure}
    ...
    \begin{figure}[h!]
        \begin{subfigure}{0.49\textwidth}
            %\centering
            %\includegraphics[width = 0.98\textwidth, height= 0.35\textheight]{images/AUROC/MSP_10.pdf}
            \includegraphics[scale=0.36]{images/AUROC/MSP_cnc_10.pdf}
            \caption{}
            \label{fig:roc_msp_10_ood_2}
        \end{subfigure}
        \begin{subfigure}{0.495\textwidth}
            %\centering
            \includegraphics[scale=0.36]{images/AUROC/Entropy_cnc_10.pdf}
            \caption{}
